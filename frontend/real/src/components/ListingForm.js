    ...
    return (
        <form className='listingform' onSubmit={e => onSubmit(e)}>
            <div className='row'>
                ...
                <div className='col-1-of-6'>
                    <div className='listingform_section'>
                        <label className='listingform_label' htmlFor='bathrooms'>Baths</label>
                    ...
                    <div className='listingform_altsection'>
                        <label className='listingform_label' htmlFor='open_house'>Open Houses</label>
                ...
                <div className='col-1-of-6'>
                    {loading ?
                        ...
                        <button className='listingform_button listingform_button_primary'>Save</button>
                    }
                </div>
            </div>
        </form>
