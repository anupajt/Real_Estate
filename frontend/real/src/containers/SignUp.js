...
const SignUp = ({setAlert, signup, isAuthenticated}) => {
    ...
    <div className="auth">
       ...
       <form className="auth_form" onSubmit={e => onSubmit(e)}>
         ...
         <div className="auth_form_group">
            <input className="auth_form_input" type="password" placeholder="Password" name="password" value={password} onChange={e => onChange(e)} minLength='6'/>
         </div>
         <div className="auth_form_group">
            <input className="auth_form_input" type="password" placeholder="Confirm Password" name="password2" value={password2} onChange={e => onChange(e)} minLength='6'/>
         </div>
         <Link to='/signin'>
